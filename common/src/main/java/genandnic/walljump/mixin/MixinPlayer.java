...
public abstract class MixinPlayer {
    ...
    @ModifyArg(method = "causeFallDamage", at = @At(value = "INVOKE", target = "net/minecraft/world/entity/LivingEntity.causeFallDamage (FFLnet/minecraft/world/damagesource/DamageSource;)Z"), index = 0)
