...
public class SpeedBoostLogic {
    public static void doSpeedBoost() {
        ...
        if(!WallJumpConfig.isModUsable(pl.level) || (WallJumpConfig.getConfigEntries().sprintSpeedBoost == 0.0 && WallJumpConfig.getConfigEntries().elytraSpeedBoost == 0.0)) return;
